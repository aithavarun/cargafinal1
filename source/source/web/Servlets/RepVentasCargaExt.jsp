...
<table width="578" align="center">
    <form method="post" action="<%=CONTROLLER%>/RepVentasCargaExt/Consultar"  name="ReportedeVentas">
        <tr>
...
<table width="578" align="center">
    ...
    <tr align="right" BGCOLOR=<%=color%>>
        ...
        <td><%=f.format(otrosSCY)%></td>
        <td><%=f.format(otrosGPS)%></td>
        <td><%=f.format(otrosUIO)%></td>
    ...
    <tr align="right" BGCOLOR="#CCFF00">
        ...
        <th title="scy"><%=f.format(totrosSCY)%></th>
        <th title="gps"><%=f.format(totrosGPS)%></th>
        <th title="uio"><%=f.format(totrosUIO)%></th>
