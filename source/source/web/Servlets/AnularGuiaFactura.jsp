...
<html>
    ...
    <body><!-- name="MantenimientoUsuarios" -->
		<form method="post" action="<%=CONTROLLER%>/Guias/BuscarGuiaAnular"  name="BuscarGuiaAnular">
			<table width="100%" align="center">
				<tr>
					<td valign="top">
						<table align="CENTER">
							<th>Anular Gu&iacute;a o Factura</th>
						</table>
		...
		<form method="post" action="<%=CONTROLLER%>/Guias/BuscarGuiaAnular"  name="MantenimientoUsuarios">
			<table>
				<tr>
					<th>Anular?</th>
					<th>Num. Guia</th>
				...
				<tr align="right">
					...
					<td><input type="checkbox" name="codAnular" value="<%=guia.getCodigo()%>"</td>
					<td><%=guia.getNumero()%></td>
					<td><%=guia.getFecha()%></td>
					<td><%=guia.getEstado()%></td>
				...
				%>
				<tr align="center">
					<td colspan="18"><input type="submit" value="Anular Guia(s) / Factura(s)" name="anularGuia"/></td>
				</tr>
				<%
							}
