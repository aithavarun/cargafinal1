...
<form method="post" action="<%=CONTROLLER%>/RepVentas/Consultarb"  name="ReportedeVentas">
<tr>
<th colspan="7">LISTA DE BOLETOS PARA BORRAR </th>
</tr>
<tr>
<td>Fecha Actual :</td>
<td>
...
long numero=0;      
 if (list != null) {
      ...
      while (it.hasNext()) {
          ...
          sec++;
          String seleccionUrl=CONTROLLER+"/Repventas/Elimina?i=12&Boleto="+repventa.getSecuencial(); 
          descuento=1;
          penalidad1=0;
         // comision=0;
          ...
          iva1=repventa.getIva()*descuento;
          tasa1=repventa.getTasa();
          seguro1=repventa.getSeguro();
          sc1=repventa.getSc();
          q1=repventa.getQ();
          penalidad1=repventa.getAdc();
          total1=repventa.getTarifa()*descuento+repventa.getIva()*descuento+repventa.getTasa()+repventa.getSeguro()+repventa.getSc()+repventa.getAdc()+repventa.getQ();
          ...
          else if (repventa.getEstado().equals("PTA"))
          {
              color="33FF99";
              estado="PTA";
              seleccionUrl=CONTROLLER+"/Repventas/Elimina?Ptanumero="+repventa.getNumero(); 
              tarifa1=0;
              iva1=0;
              tasa1=0;
              seguro1=0;
          ...
          total=total+repventa.getTarifa()*descuento+repventa.getIva()*descuento+repventa.getTasa()+repventa.getSeguro()+repventa.getSc()+repventa.getAdc()+repventa.getQ();
          
          ventas=repventa.getTarifa()*descuento+repventa.getIva()*descuento+repventa.getTasa()+repventa.getSeguro()+repventa.getSc()+repventa.getAdc()+repventa.getQ();
          ventas1=ventas;
  ...
  <tr align="right" BGCOLOR=<%=color%>>
        ...
        <td><A HREF="<%=seleccionUrl%>"> <%=repventa.getNumero()%></td>
