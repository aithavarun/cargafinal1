...
<tr>
<td><b> Numero de Guia:</b></td><td><input name= "Nguia" id="Nguia" value="0"  type="text"  size="10" maxlength="10" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" > 
</tr>
<tr>
<td>
...
<input name="piezas" value=1  type="text" size="2" maxlength="2" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;">
</td>

<td><b>Peso: </b>
</td><td>
<input name="peso"  value=0  type="text" size="2" maxlength="2" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;">
</td>

<td><b>Peso Por Volumen: </b>
</td><td>
<input name="pesovolumen"  value=0  type="text" size="2" maxlength="2" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;">
</td>
...
<tr>
<td><b>Flete: </b></td>
<td colspan="2"  ><input name="Flete" value=0 align="right" type="text" size="20"  ></td> 
</tr>
...
<td colspan="2"  ><input name="Sadicional"  value=0   type="text" size="20" align="right" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" ></td> 
</tr>


<tr>
<td><b>Seguros: </b></td>
<td colspan="2"  ><input name="Seguros"  value=0   type="text" size="20" align="right" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" ></td> 
</tr>

<tr>
<td><b>Subtotales: </b></td>
<td colspan="2"  ><input name="Subtotales"  value=0   type="text" size="20" align="right"  onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;"></td> 
</tr>


<tr>
<td><b>Descuentos: </b></td>
<td colspan="2"  ><input name="Descuentos"  value=0   type="text" size="20" align="right" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;"></td> 
</tr>

<tr>
<td><b>Iva: </b></td>
<td colspan="2"  ><input name="Iva"  value=0   type="text" size="20" align="right" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;"></td> 
</tr>


<tr>
<td><b>Obs: </b></td>
<td colspan="5"><textarea name="Observacion" cols="80" rows="2"><%=Obs%></textarea></td>
</tr>
<tr>
