...
//Fila con los nombres de días de la semana
escrmiCelda(mitabla,0, 0, 'Base','nombmes');
escrmiCelda(mitabla,1, 0, 'Comision','nombmes');
escrmiCelda(mitabla, 2,0, '% Comision','nombmes');
mitabla.rows[0].className = CSSnombdias;
...
for (f=0;f<filas;f++)
	...
	for(c=0; c<cols; c++)
		...
		textVal='';
      	textNode = document.createTextNode(textVal);
        //textNode = document.createTextNode('f'+f+'c'+c);
      	tCelda.appendChild(textNode);
		tCelda.align="center";
		tFila.appendChild(tCelda);
		}
...
/*=====================================================================================
	...
	DESCRIP:	Escribe valor en la celda ind de la tabla pasada como argumento
=====================================================================================*/
function escrmiCelda(tabla, Col,Fil, valor, est)
{
var tCelda, textNode, Col1, Fil1;
//var Col = ind%3;
