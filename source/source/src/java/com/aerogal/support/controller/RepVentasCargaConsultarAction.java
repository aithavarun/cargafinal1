...
public class RepVentasCargaConsultarAction extends Action
{

    public RepVentasCargaConsultarAction()
    {
    }
        ...
        throws ServletException, IOException
    {
        ...
        try
        {
            model.buscarRepventasWTC(psucursal, usuario, dia, mes, anio, documento);
        }
