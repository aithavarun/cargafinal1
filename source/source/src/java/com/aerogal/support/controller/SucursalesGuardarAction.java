// Decompiled by DJ v3.11.11.95 Copyright 2009 Atanas Neshkov  Date: 25/02/2011 11:02:21
// Home Page: http://members.fortunecity.com/neshkov/dj.html  http://www.neshkov.com/dj.html - Check often for new version!
// Decompiler options: packimports(3) 
// Source File Name:   SucursalesGuardarAction.java
...
public class SucursalesGuardarAction extends Action
{

    public SucursalesGuardarAction()
    {
    }
        ...
        throws ServletException, IOException
    {
        ...
        {
            if(guardar != null)
                model.GrabarSucursales(codigo, descripcion, Serie, Long.parseLong(Manifiesto),Long.parseLong(numguia),Long.parseLong(numfactura),rguia,rfactura );
