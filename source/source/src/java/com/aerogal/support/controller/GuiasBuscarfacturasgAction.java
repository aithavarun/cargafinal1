// Decompiled by DJ v3.11.11.95 Copyright 2009 Atanas Neshkov  Date: 25/02/2011 10:58:49
// Home Page: http://members.fortunecity.com/neshkov/dj.html  http://www.neshkov.com/dj.html - Check often for new version!
// Decompiler options: packimports(3) 
// Source File Name:   GuiasBuscarfacturasgAction.java
...
public class GuiasBuscarfacturasgAction extends Action
{

    public GuiasBuscarfacturasgAction()
    {
    }
        ...
        throws ServletException, IOException
    {
        ...
        try
        {
            ...
            if(Buscar != null)
            {
                model.GuiasxFecha(dia, mes, anio, dia2, mes2, anio2, Integer.parseInt(Cliente), "F", Sucursal);
                model.setAccion("1");
                pagina = "/Servlets/ReportesFacturasg.jsp";
            }
        }
