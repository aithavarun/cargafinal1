...
<form method="post" action="<%=CONTROLLER%>/Pta/Modificar"  
name="TarifasReservas"   onSubmit="return validar(this)" 
>

<table width="100%" align="CENTER">
<tr class="form1">
<th colspan="8" >Modificar PTA</th>
</tr>
<tr class="form1">
...
<td align="right">
<span id="rValor<%=i%>"  style="position:relative;">
...
<td align="right">
<span id="rIva<%=i%>"  style="position:relative;">
...
<td align="right">
<span id="rTtotal<%=i%>"  style="position:relative;">
<%=f.format(rtvalor*descuento+rtiva*descuento+rttasa+rtseguro )%>
</span>
<input name="rttotal<%=i%>" value="<%=rtvalor+rtiva+rttasa+rtseguro%>" 
type="hidden"  >
</td>
<%------------------------------
<script language="JavaScript"> 
...
<%=f.format(reserva.getValor()*descuento+reserva.getIva()*descuento+reserva.getSeguro()+reserva.getTasa())%>
<input name="totali<%=j%>" value="<%=reserva.getValor()+reserva.getIva()+reserva.getSeguro()+reserva.getTasa()%>" 
type="hidden"  >
</span>
</td>
...
<%=f.format(tvalor+tiva+ttasa+tseguro)%>
<input name="ttotal" value="<%=tvalor+tiva+ttasa+tseguro%>" 
type="hidden"  >
</span>
</td>
...
<tr class="form1">
<th colspan="8" >Formas de Pago</th>
</tr>
...
type="text" size="8" maxlength="4" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" >
</td>
<td colspan="1">
