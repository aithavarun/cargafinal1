...
<form method="post" action="<%=CONTROLLER%>/Itinerarios/Buscar"  name="BuscarItinerarios" >
<table width="100%" align="center">
<tr>
<th colspan="4">Mantenimiento de Itinerarios</th>
</tr>
<tr>
<td>Origen :
...
<table width="100%" align="center">
<form method="post" action="<%=CONTROLLER%>/Itinerarios/Nuevo"  name="MantenimientoItinerarios">
<tr>
<td valign="top">
...
<%
 ...
 if (list != null) {
      ...
      while (it.hasNext()) {
          ...
          String seleccionUrl=CONTROLLER+"/Itinerarios/Selecciona?codigo="+itinerario.getCodigo() ;
          %>
  <tr>
      
       <td><A HREF="<%=seleccionUrl%>"> <%=itinerario.getNumero()%></a></td>
