...
<html>
    <head>
<!--        <title>IMPRESION GUIA DE CARGA11.1</title>-->
        <style type="text/css">
            body   { background:#FFF;
                     margin:0; padding:0;}
            .fc   { color     : black;
    ...
    <%--<body>     --%>
        ...
        <div  style="position:absolute; left:19cm;top:0.65cm">
            <span class="fc"><%=numfactura%></span>
        </div>

        <div  style="position:absolute; left:15.5cm;top:1.3cm">
            <span class="fc"><%=contiene%></span>
        </div>

        <div  style="position:absolute; left:0.9cm;top:1.55cm">
            <span class="fc"><%=lfecha%></span>
        </div>

        <div  style="position:absolute; left:3.8cm; top:1.55cm">
            <span class="fc"><%=lhora%></span>
        </div>


        <div  style="position:absolute; left:6.4cm; top:1.55cm"> 
            <span class="fc"><%=piezas%></span>
        </div>


        <div  style="position:absolute; left:8.3cm;top:1.55cm">
            <span class="fc"><%=f.format(peso)%></span>
        </div>

        <div  style="position:absolute; left:10.8cm;top:1.55cm">
            <span class="fc"><%=f.format(pesov)%></span>
        </div>

        <div  style="position:absolute; left:16.3cm;top:1.55cm">
            <span class="fc">S.V.D.</span>
        </div>

        <div  style="position:absolute; left:2.5cm;top:2.1cm">
            <span class="fc"><%=remitente%></span>
        </div>

        <div  style="position:absolute; left:10.0cm; top:2.1cm">
            <span class="fc"><%=destino%></span>
        </div>
        
        <div  style="position:absolute; left:15.3cm; top:2.1cm">
            <span class="fc"><%=destinatario%></span>
        </div>

        <div  style="position:absolute; left:3.3cm;top:2.6cm">
            <span class="fc"><%=origen%></span>
        </div>

        <div  style="position:absolute; left:6.0cm;top:2.6cm">
            <span class="fc"><%=telefono%></span>
        </div>

        <div  style="position:absolute; left:14.9cm; top:2.6cm">
            <span class="fc"><%=direccion%></span>
        </div>

        <div  style="position:absolute; left:2.2cm;top:3.2cm">
            <span class="fc"><%=ruc%></span>
        </div>

        <div  style="position:absolute; left:11.8cm;top:3.2cm">
...
<!--        <div  style="position:absolute; left:16.2cm;top:3.1cm ">
        ...
        <div  style="position:absolute; left:20.055cm; top:3.1cm">
            <span class="fc"><%=aeropuerto%></span>
        </div>-->


        <div  style="position:absolute; left:1.3cm;top:4.3cm">
        ...
        <div  style="position:absolute; left:17.7cm; top:4.1cm">
...
<!--        <div  style="position:absolute; left:17.674cm; top:4.683cm">
            <span class="fc"><%=f.format(edomicilio)%></span>
        </div>-->

        <%%>
        <div  style="position:absolute; left:1.3cm;top:4.4cm ">
            <span class="fc"><%=obs1%></span>
        </div>
        <%%>


<!--        <div  style="position:absolute; left:17.674cm; top:5.106cm">
            <span class="fc"><%=f.format(tadicional)%> </span>
        </div>-->

<!--        <div  style="position:absolute; left:17.674cm; top:5.503cm">
            <span class="fc"><%=f.format(sadicional)%></span>
        </div>-->

        <div  style="position:absolute; left:17.7cm; top:4.7cm">
            <span class="numbcolumn"><%=f.format(seguro)%></span>
        </div>

        <div  style="position:absolute; left:0.5cm;top:5.8cm">
            <span class="fc"><%=usuariox%></span>
        </div>
 <!--        <div  style="position:absolute; left:18.7cm; top:5.8cm">
            <span class="fc"><%=f.format(descuento)%></span>
        </div>-->
        ...
        %>
        <div  style="position:absolute; left:15.9cm; top:5.3cm">
        ...
        %>
        <div  style="position:absolute; left: 17.7cm; top:5.3cm">
            <span class="numbcolumn">0.00</span>
        </div>
        <%}%>
        <div  style="position:absolute; left: 17.7cm; top:6.0cm; ">
            <span class="numbcolumn"><%=f.format(subtotal)%></span>
        </div> 
        <% if (iva > 0) {
        %>    

        <div  style="position:absolute; left: 14.2cm;top:6.9cm;">
        ...
        %>
        <div  style="position:absolute; left:17.7cm; top:6.5cm">
            <span class="numbcolumn">0.00</span>
        </div>

        <div  style="position:absolute; left:17.7cm; top:7.0cm">
            <span class="numbcolumn"><%=f.format(iva)%></span>
        </div>

        <div  style="position:absolute; left:17.7cm; top:7.4cm">
