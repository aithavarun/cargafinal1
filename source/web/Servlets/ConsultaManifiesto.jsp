...
<form method="post" action="<%=CONTROLLER%>/ReporteManifiestos/Buscar"  
...
<tr>
<td align="left"> <b> Observaciones: <input name="Observaciones"  value="<%=obs%>" type ="text" size="90" maxlength="90" readonly> </b> </td>
...
<tr>
    <td ><input name="Reimprimir" type="submit" id="Reimprimir" value="Reimprimir"  onclick="nosalir();"></td>
</tr>
</table>
</form>