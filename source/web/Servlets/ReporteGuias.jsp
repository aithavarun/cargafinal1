...
<form method="post" action="<%=CONTROLLER%>/Guias/Buscarguias"  
    name="MantenimientoGuias" onSubmit="return validar(this)"  >
     <input name="baseurl" value="<%=BASEURL%>" 
type="hidden"  >
<tr>
<th colspan="25">CARGA AEROGAL - REPORTE GUIAS  </th>
</tr>
<tr>
...
<script language="JavaScript" type="text/javascript">
   ...
   MantenimientoGuias.Sucursal.options.value="<%=Misucursal%>"
