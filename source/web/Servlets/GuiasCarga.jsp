...
<%SimpleDateFormat FORMATOFECHA=new SimpleDateFormat("E , d MMM - yyyy");%>
<tr>
<th > Nª Guia</th>
<th > Piezas</th>
<th > Peso</th>
...
if (lista != null){
     Iterator itr = lista.iterator();
      while (itr.hasNext()){
             ...
             <td><%=guia.getNumero()%> </b></td>
             <td align="right" ><span id="Piezas<%=secuencial%>"><%=guia.getPiezas()%></span></td>             
             <td align="right"><span id ="Peso<%=secuencial%>"><%=f.format(guia.getPeso())%></span></td>
             <td><%=Destino%></td>
             ...
             <tr   bgcolor="<%=filascolor%>">
             <td><b> Totales </a></b></td>
             <td><input  name="TotalPiezas" value="<%=totalpz%>" type="text" size="10" maxlength="20" readonly align="right"> </td>
             <td><input  name="TotalPeso" value="<%=totalps%>" type="text" size="10" maxlength="20" readonly align="right"></td>
