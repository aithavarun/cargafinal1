...
<li  style="width:145px;"><a href="#" target="_self">Carga</a>
	...
	<div><div style="width:146px;top:0px;left:-1px;"><ul style="">
       ...
       {%>
        ...
        <li><a href="TiposdeTarifas-" target="_self">Tipos de Tarifas</a></li>
	<li><a href="TarifasCarga-" target="_self">Tarifas Carga</a></li>
        <%}%>
        <li><a href="Guias-" target="_self">Guias Factura</a></li>
        <li><a href="AnularG-" target="_self">Anular Guia / Factura </a></li>
        <li><a href="Manifiesto-" target="_self">Reporte de Ventas</a></li>
        <li><a href="ManifiestoC-" target="_self">Manifiesto Carga</a></li>
        <li><a href="DespachoGuia-" target="_self">Despacho de Guias </a></li> 
        <li><a href="FacturaciondeGuias-" target="_self">Facturacion de Guias  </a></li> 
