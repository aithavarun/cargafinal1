...
<title>::: Carga Aerogal ::: <%=model.getIpdir()%> </title>
...
<link href="<%=BASEURL%>/MonthPicker.css" rel="stylesheet" type="text/css" />

<script src="<%=BASEURL%>/jquery-3.2.1.min.js"></script>
<script src="<%=BASEURL%>/jquery.mask-1.14.10.js"></script>
<!--<script src="<%=BASEURL%>/MonthPicker.js"></script>-->
<!--<script src="<%=BASEURL%>/examples.js"></script>-->
...
<%
    List listamenu =model.BuscarPerfil(usuario.getNombre().trim() ,"1");
    if (listamenu != null) {
        Iterator it = listamenu.iterator();
        while (it.hasNext()) {
         Menus menu=(Menus) it.next();
         %>
                       
       <li><a href="<%=menu.getClave() %>" target="_self"><%=menu.getNombre() %>  </a></li> 
                    
        <%
        if (menu.getClave().trim().equals("#"))
          {
            %>
            <div style="width:150px;top:40px;left:133px;"><ul style=""> 
             <%}}} %>
...
<li  style="width:145px;"><a href="#" target="_self">Carga</a>
    ...
    <%
    listamenu =model.BuscarPerfil(usuario.getNombre().trim() ,"2");
    if (listamenu != null) {
        Iterator it = listamenu.iterator();
        while (it.hasNext()) {
         Menus menu=(Menus) it.next();
    ...
    <li  style="width:145px;"><a href="#" target="_self">Reportes </a>
    <div><div style="width:146px;top:0px;left:-1px;"><ul style="">
    
        <%
    listamenu =model.BuscarPerfil(usuario.getNombre().trim() ,"3");
    if (listamenu != null) {
        Iterator it = listamenu.iterator();
        while (it.hasNext()) {
         Menus menu=(Menus) it.next();
